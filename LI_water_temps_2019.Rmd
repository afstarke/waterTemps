...
Red ribbon = 2019 temperature range based on daily max and min at each station. Grey ribbon is average max and min by day for the previous 6
...
daily_mean_7yr %>% ggplot(aes(x = commonDate, y = temp_mean7yr)) + 
